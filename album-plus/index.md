...
features:
  - title: 产品库
    details: 产品库从多个维度管理产品。品类维度，从产品分类管理。系列文件夹维度则赋予企业更大的自由度，可根据需要自定义文件夹。管理产品主图、产品图、详情图、实拍图、效果图等图片。实现企业数字化转型。
  - title: 方案设计
    details: 轻松制作完整的报价方案。首先创建项目方案，自定义空间，从图册中选取合适的家具产品添加到对应空间，并灵活设置所需数量，修改价格，自定义产品信息。方案完成后，一键生成精准报价，支持导出Excel表格方便存档或打印，更可生成专属链接直接分享给客户，提升工作效率与专业形象
  - title: 分享
    details: 企业员工可对产品、图册、报价清单等内容进行分享。且可对分享信息进行控制，如改价，设置显示字段，改图等。生成分享链接，转发给微信好友，提升工作效率
  - title: 物料生成

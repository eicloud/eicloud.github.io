...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', {name: 'keywords', content: '极智云，超级图册，零代码，低代码，apaas，在线表单，表单引擎，流程引擎，仪表盘，在线报表，报表引擎，数据管理，工作台，应用搭建，组织架构，可视化设计器，自定义公式，CRM，ERP，CMS，OA'}],
  ...
  themeConfig: {
    ...
    search: {
      ...
      options: {
        appId: 'CJA7UEH8KO',
        apiKey: 'd46f949596fc459358339b916d8d68a8',
        indexName: 'jzy',
        locales: {
          root: {
            placeholder: '搜索',
